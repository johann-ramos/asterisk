...
public class GetInfoResponse  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ObtenerTipoTarifa", ">getInfoResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("getInfoReturn");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ObtenerTipoTarifa", "getInfoReturn"));
