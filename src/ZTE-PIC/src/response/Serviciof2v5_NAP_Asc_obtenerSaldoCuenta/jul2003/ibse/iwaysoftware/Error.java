...
public class Error  implements java.io.Serializable {
    ...
    /**
     * Gets the codigoError value for this Error.
     * 
     * @return codigoError
     */
    ...
    /**
     * Sets the codigoError value for this Error.
     * 
     * @param codigoError
     */
    ...
    /**
     * Gets the descripcionError value for this Error.
     * 
    ...
    /**
     * Sets the descripcionError value for this Error.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iwaysoftware:ibse:jul2003:Serviciof2v5_NAP_Asc_obtenerSaldoCuenta:response", "Error"));
